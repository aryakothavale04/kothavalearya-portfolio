...
export default function About() {
  return (
    <section id="about" className="container-shell py-16 sm:py-20">
      <div className="mx-auto grid max-w-6xl items-stretch gap-6 lg:grid-cols-[0.88fr_1.12fr]">
        <motion.div initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.3 }} className="glass-card rounded-3xl p-6 sm:p-7 lg:h-full">
        ...
        <motion.div initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.3 }} transition={{ delay: 0.08 }} className="flex rounded-3xl border border-line bg-white p-6 shadow-premium sm:p-8 lg:h-full lg:items-center">
          <div>
